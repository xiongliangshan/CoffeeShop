...
public class ExceptionalModelImpl implements ExceptionalModel {
    ...
    @Override
    public void loadExceptionalOrdes(int shopId, String token, Observer<BaseEntity<List<ExceptionalOrder>>> observer) {
    ...
    @Override
    public void doRePush(int shopId, long orderId, int deliverTeam, String token, Observer<BaseEntity> observer) {
