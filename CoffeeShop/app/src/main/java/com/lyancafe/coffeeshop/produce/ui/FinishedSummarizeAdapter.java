...
public class FinishedSummarizeAdapter extends RecyclerView.Adapter<FinishedSummarizeAdapter.ViewHolder> {
    ...
    public FinishedSummarizeAdapter(Context mContext) {
        this.mContext = mContext;
    }

    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.finished_summarize_item, parent, false);
